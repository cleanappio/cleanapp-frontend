...
export const translations: {
  ...
  en: {
    ...
    resetLinkExpiredOrInvalid: "This password reset link is invalid or has expired.",
    ...
    viewSampleCleanAppProSubscriberDashboard:
    ...
    forBusinessesAndBrands:
      "For businesses & brands that need deeper visibility",
    ...
    forOrganizationsManagingMultiple:
    ...
    pleaseCompleteAuthenticationToContinueWithCheckout:
      "Please complete authentication to continue with checkout",
    ...
    failed_to_update_default_payment_method:
    ...
    subscribe: "Subscribe",
    yourPaymentInformationIsEncryptedAndSecure:
    ...
    privacyPolicyPersonalInformation:
      "1.1 Personal Information: We may collect personal information such as your avatar name and a blockchain address when you register in our app. Your avatar name and a blockchain address are securely stored on your device and are sent within your reports to process rewards.",
    privacyPolicyUsageData:
      "1.2 Usage Data: Our app collects information about your location when you use the application, i.e. take a litter or hazard report.",
    useOfInformation: "Use of Information",
    privacyPolicyUseOfPersonalInformation:
      "2.1 Personal Information: We use your blockchain address to process game rewards. We send points you won to your blockchain address once a day. After that we remove your avatar and blockchain address from your reports and your reports become anonymized. If you consent to publish reports with your avatar, we will keep your avatar connected to reports.",
    privacyPolicyUseOfUsageData:
      "2.2 Usage Data: We use anonymized location data to aggregate report data by certain locations and send alerts to remediators for taking action on your reports.",
    informationSharing: "Information Sharing",
    privacyPolicyDataPublishing:
      "3.1 Data Publishing: We may publish your reports with your avatar only if you consent. Otherwise all reports are published anonymously.",
    privacyPolicyThirdPartyProviders:
      "3.2 Third-Party Service Providers: We may share your personal information with trusted third-party service providers who assist us in operating our website, conducting our business, or providing services to you. These service providers have access to your personal information only to perform tasks on our behalf and are obligated not to disclose or use it for any other purpose.",
    privacyPolicyLegalCompliance:
      "3.3 Legal Compliance: We may disclose your personal information if required by law or in response to valid requests by public authorities (e.g., a court or government agency).",
    ...
    privacyPolicyYourChoices:
      "You have the right to access, correct, or delete your personal information. You can also choose to unsubscribe from our marketing communications or adjust your preferences by contacting us at privacy@cleanapp.io.",
    updatesToPrivacyPolicy: "Updates to this Privacy Policy",
    privacyPolicyUpdates:
      "We may update this Privacy Policy from time to time to reflect changes in our practices or applicable laws. We will notify you of any significant changes by posting the updated Privacy Policy on our website or by other means of communication.",
    privacyPolicyContactUs:
      "If you have any questions, concerns, or requests regarding this Privacy Policy or the handling of your personal information, please contact us at privacy@cleanapp.io.",
    ...
    mustBeLoggedInToViewReportDetails:
      "You must be logged in to view report details.",
    ...
    selectAReportFromMapToViewDetailedAnalysis:
      "Select a report from the map to view detailed analysis",
    clickOnAReportFromTheMapToSeeDetailedInformation:
    ...
    areasSelectionDescription:
      "Use the drawing tools on the map below to create and edit service areas for your subscription.",
    mapView: "Map View",
    createNewArea: "Create New Area",
    editArea: "Edit Area",
    areaName: "Area Name",
    areaNamePlaceholder: "Enter area name",
    areaDescription: "Description (optional)",
    areaDescriptionPlaceholder: "Enter area description",
    drawingInstructions:
      'Instructions: Use the drawing tools on the map below to create or edit the area boundary. Click the polygon tool and draw your area, then click "Save changes" above.',
    selectedAreas: "Selected Areas",
    selectedAreasCount: "{count} area{plural} selected",
    noAreasSelected:
      "No areas selected. Use the drawing tools on the map to create service areas.",
    serviceAreas: "Service Areas",
    areasSelected: "{count} area{plural} selected",
    noAreasSelectedCheckout:
      "Click on areas on the map to select areas to get reports for.",
    pleaseCompleteAuthenticationToSelectAreas:
      "No areas selected. Please complete authentication to select service areas.",
  ...
  me: {
    ...
    canNowLogin: "Sada se možete prijaviti sa novom lozinkom.",
    backToLogin: "Nazad na prijavu",
    invalidResetLink: "Nevažeća veza za resetovanje",
    resetLinkExpiredOrInvalid: "Ova veza za resetovanje lozinke je nevažeća ili je istekla.",
    passwordsMustMatch: "Lozinke se moraju poklapati",
    resettingPassword: "Resetovanje...",
    ...
    support: "Podrška",
    poweredBy: "Pokreće",
    viewSampleDigitalCleanAppReport:
      "Pogledajte primer digitalnog CleanApp izveštaja",
    viewSampleCleanAppProSubscriberDashboard:
      "Pogledajte primer CleanAppPro pretplatničke kontrolne table",
    ...
    upgradeToAccessRealtimeMonitoring:
      "Nadogradi za pristup praćenju u realnom vremenu",
    ...
    cleanAppLive: "CleanAppLive",
    forBusinessesAndBrands:
      "Za biznise i brendove koji trebaju dublju vidljivost",
    ...
    forOrganizationsManagingMultiple:
      "Za organizacije koje upravljaju više lokacija, brendova ili digitalnih platformi",
    ...
    liveInsightsLowerCosts:
      "UŽIVO uvid, niži troškovi održavanja i odgovornosti,",
    ...
    pleaseCompleteAuthenticationToContinueWithCheckout:
      "Molimo završite autentifikaciju da nastavite sa plaćanjem",
    ...
    confirm_cancel_subscription:
      "Da li ste sigurni da želite da otkažete pretplatu? Ova akcija se ne može poništiti.",
    ...
    confirm_remove_payment_method:
      "Da li ste sigurni da želite da uklonite ovaj način plaćanja?",
    ...
    failed_to_update_default_payment_method:
      "Neuspešno ažuriranje podrazumevanog načina plaćanja",
    ...
    yourPaymentInformationIsEncryptedAndSecure:
      "Vaši podaci o plaćanju su šifrovani i sigurni. Možete otkazati pretplatu u bilo kom trenutku.",
    ...
    privacyPolicyPersonalInformation:
      "1.1 Lične informacije: Možemo prikupiti lične informacije kao što su vaše avatar ime i blockchain adresa kada se registrujete u našoj aplikaciji. Vaše avatar ime i blockchain adresa se sigurno čuvaju na vašem uređaju i šalju se u vašim izveštajima za obradu nagrada.",
    privacyPolicyUsageData:
      "1.2 Podaci o korišćenju: Naša aplikacija prikuplja informacije o vašoj lokaciji kada koristite aplikaciju, npr. napravite izveštaj o smeću ili opasnosti.",
    useOfInformation: "Korišćenje informacija",
    privacyPolicyUseOfPersonalInformation:
      "2.1 Lične informacije: Koristimo vašu blockchain adresu za obradu nagrada u igri. Šaljemo poene koje ste osvojili na vašu blockchain adresu jednom dnevno. Nakon toga uklanjamo vaš avatar i blockchain adresu iz vaših izveštaja i vaši izveštaji postaju anonimni. Ako pristanete da objavite izveštaje sa vašim avatarom, zadržaćemo vaš avatar povezan sa izveštajima.",
    privacyPolicyUseOfUsageData:
      "2.2 Podaci o korišćenju: Koristimo anonimizirane podatke o lokaciji za agregiranje podataka izveštaja po određenim lokacijama i slanje upozorenja remedijatorima za preduzimanje akcije na vašim izveštajima.",
    informationSharing: "Deljenje informacija",
    privacyPolicyDataPublishing:
      "3.1 Objava podataka: Možemo objaviti vaše izveštaje sa vašim avatarom samo ako pristanete. U suprotnom, svi izveštaji se objavljuju anonimno.",
    privacyPolicyThirdPartyProviders:
    ...
    privacyPolicyLegalCompliance:
      "3.3 Pravna usklađenost: Možemo otkriti vaše lične informacije ako to zahteva zakon ili kao odgovor na važeće zahteve javnih organa (npr. sud ili državna agencija).",
    dataSecurity: "Sigurnost podataka",
    privacyPolicyDataSecurity:
      "Implementiramo razumne sigurnosne mere za zaštitu vaših ličnih informacija od neovlašćenog pristupa, otkrivanja, izmene ili uništavanja. Međutim, imajte na umu da nijedan metod prenosa preko interneta ili elektronskog skladištenja nije 100% siguran i ne možemo garantirati apsolutnu sigurnost.",
    yourChoices: "Vaši izbori",
    privacyPolicyYourChoices:
      "Imate pravo da pristupite, ispravite ili obrišete svoje lične informacije. Takođe možete izabrati da se odjavite iz naših marketinških komunikacija ili prilagodite svoje preferencije kontaktiranjem nas na privacy@cleanapp.io.",
    updatesToPrivacyPolicy: "Ažuriranja ove Politike privatnosti",
    privacyPolicyUpdates:
      "Možemo ažurirati ovu Politiku privatnosti s vremena na vreme da odražavamo promene u našim praksama ili primenjivim zakonima. Obavestićemo vas o bilo kojim značajnim promenama objavljivanjem ažurirane Politike privatnosti na našoj web stranici ili drugim sredstvima komunikacije.",
    privacyPolicyContactUs:
      "Ako imate bilo kakva pitanja, brige ili zahteve u vezi sa ovom Politikom privatnosti ili rukovanjem vašim ličnim informacijama, molimo kontaktirajte nas na privacy@cleanapp.io.",
    ...
    failedToGeneratePDF:
      "Neuspešno generisanje PDF-a. Molimo pokušajte ponovo.",
    mustBeLoggedInToViewReportDetails:
      "Morate biti prijavljeni da vidite detalje izveštaja.",
    ...
    selectAReportFromMapToViewDetailedAnalysis:
      "Izaberite izveštaj sa mape da vidite detaljnu analizu",
    clickOnAReportFromTheMapToSeeDetailedInformation:
      "Kliknite na izveštaj sa mape da vidite detaljne informacije",
    ...
    // Areas Selection
    selectServiceAreas: "Izaberite zone usluga",
    areasSelectionDescription:
      "Koristite alate za crtanje na mapi ispod da kreirate i uredite zone usluga za vašu pretplatu.",
    mapView: "Pregled mape",
    createNewArea: "Kreiraj novu zonu",
    editArea: "Uredi zonu",
    areaName: "Naziv zone",
    areaNamePlaceholder: "Unesite naziv zone",
    areaDescription: "Opis (opciono)",
    areaDescriptionPlaceholder: "Unesite opis zone",
    drawingInstructions:
      'Uputstva: Koristite alate za crtanje na mapi ispod da kreirate ili uredite granicu zone. Kliknite na alat za poligon i nacrtajte vašu zonu, zatim kliknite "Sačuvaj promene" iznad.',
    selectedAreas: "Izabrane zone",
    selectedAreasCount: "{count} zona{plural} izabrano",
    noAreasSelected:
      "Nema izabranih zona. Koristite alate za crtanje na mapi da kreirate zone usluga.",
    serviceAreas: "Zone usluga",
    areasSelected: "{count} zona{plural} izabrano",
    noAreasSelectedCheckout:
      "Kliknite na zone na mapi da izaberete zone za dobijanje izvještaja.",
    pleaseCompleteAuthenticationToSelectAreas:
      "Nema izabranih zona. Molimo završite autentifikaciju da izaberete zone usluga.",
...
export function filterAnalysesByLanguage(
  ...
  if (!Array.isArray(reportsWithAnalyses)) {
    console.warn(
      "filterAnalysesByLanguage: Input is not an array:",
      reportsWithAnalyses
    );
    return [];
  }
    ...
    .map((reportWithAnalysis) => {
      ...
      const filteredAnalyses = analyses.filter(
        (analysis: any) =>
          analysis &&
          analysis.language &&
          analysis.language.toLowerCase() === currentLocale.toLowerCase()
      );

      // If no analysis found for current language, try to find English as fallback
      if (filteredAnalyses.length === 0) {
        const englishAnalyses = analyses.filter(
          (analysis: any) =>
            analysis &&
            analysis.language &&
            analysis.language.toLowerCase() === "en"
        );
