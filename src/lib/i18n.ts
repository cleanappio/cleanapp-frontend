...
export const translations: {
  ...
  en: {
    ...
    areasSelectionDescription: 'Use the drawing tools on the map below to create and edit service areas for your subscription.',
    mapView: 'Map View',
    ...
    drawingInstructions: 'Instructions: Use the drawing tools on the map below to create or edit the area boundary. Click the polygon tool and draw your area, then click "Save changes" above.',
    selectedAreas: 'Selected Areas',
    selectedAreasCount: '{count} area{plural} selected',
    noAreasSelected: 'No areas selected. Use the drawing tools on the map to create service areas.',
    serviceAreas: 'Service Areas',
    areasSelected: '{count} area{plural} selected',
    noAreasSelectedCheckout: 'No areas selected. Click "Select Areas" to choose your service areas.',
  ...
  me: {
    ...
    areasSelectionDescription: 'Koristite alate za crtanje na mapi ispod da kreirate i uredite zone usluga za vašu pretplatu.',
    ...
    drawingInstructions: 'Uputstva: Koristite alate za crtanje na mapi ispod da kreirate ili uredite granicu zone. Kliknite na alat za poligon i nacrtajte vašu zonu, zatim kliknite "Sačuvaj promene" iznad.',
    selectedAreas: 'Izabrane zone',
    selectedAreasCount: '{count} zona{plural} izabrano',
    noAreasSelected: 'Nema izabranih zona. Koristite alate za crtanje na mapi da kreirate zone usluga.',
    serviceAreas: 'Zone usluga',
    areasSelected: '{count} zona{plural} izabrano',
    noAreasSelectedCheckout: 'Nema izabranih zona. Kliknite "Izaberite zone" da izaberete vaše zone usluga.',
